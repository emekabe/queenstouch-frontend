...
@Component({
    ...
    <div class="bg-secondary min-vh-100 py-5">
      ...
      <div class="container" style="max-width: 600px;">
        ...
        <div class="card p-4 border-none shadow-sm">
          ...
          <p class="text-muted small">Deleting your account is permanent. All your resumes, data, and active orders will be wiped immediately.</p>
          <div>
  ...
  styles: [`
    ...
    .btn-outline-danger:hover { background: var(--qt-danger); color: white; }
