...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, RouterModule, SpinnerComponent, FileUploadComponent],
  template: `
          ...
          <form [formGroup]="requestForm" (ngSubmit)="submitRequest()">
            <div class="form-group mb-4">
              ...
              <small class="text-muted d-block mt-1"
                >Normally this would list actual purchased Order IDs to link to.</small
              >
            </div>
            ...
            <div class="form-group mt-3">
              ...
              <textarea
                ...
                rows="5"
                placeholder="Let our experts know exactly what you are aiming for..."
              ></textarea>
            </div>
      ...
      next: (res: any) => {
        ...
        this.premiumReqService.uploadFile(id, this.selectedFile!).subscribe({
          next: () => {
            ...
            this.toast.success(
              'Premium request submitted successfully! An expert will review it soon.',
            );
