...
import {
  ...
  Project,
  CvScore,
} from '../models/cv.interface';

@Component({
  selector: 'app-cv-builder',
  standalone: true,
  imports: [ReactiveFormsModule, SpinnerComponent, ScoreRingComponent, NavbarComponent],
  template: `
          ...
          <div class="col-form">
            <div class="card p-4 shadow-sm border-none">
              ...
              <form [formGroup]="cvForm">
                    ...
                    <div class="grid-2">
                      ...
                      <div class="form-group" style="grid-column: span 2;">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          formControlName="targetJobTitle"
                  ...
                  <div class="step-content">
                    <div class="form-group">
                      ...
                      <p class="small text-muted mb-3">
                        Highlight your top achievements and core expertise.
                      </p>
                      <textarea
                        class="form-control"
                        formControlName="professionalSummary"
                        rows="6"
                        placeholder="I am a highly driven professional..."
                      ></textarea>
                    </div>
                  </div>
                }
                ...
                @if (currentStep === 3) {
                  <div class="step-content">
                    ...
                    @for (exp of experienceArray.controls; track exp; let i = $index) {
                      <div formArrayName="experience" class="mb-4 p-3 border rounded">
                        <div [formGroupName]="i">
                ...
                @if (currentStep === 4) {
                  <div class="step-content">
                    ...
                    @for (edu of educationArray.controls; track edu; let i = $index) {
                      <div formArrayName="education" class="mb-4 p-3 border rounded">
                        <div [formGroupName]="i">
                          <div class="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <div class="step-content">
                    ...
                    <div formArrayName="skills">
                      @for (skill of skillsArray.controls; track skill; let i = $index) {
                        <div class="d-flex mb-3" [formGroupName]="i">
                ...
                @if (currentStep === 6) {
                  <div class="step-content">
                    ...
                    @for (proj of projectsArray.controls; track proj; let i = $index) {
                      <div formArrayName="projects" class="mb-4 p-3 border rounded">
                        <div [formGroupName]="i">
                          <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                @if (currentStep === 7) {
                  <div class="step-content text-center">
                    <div class="mb-4">
                      ...
                      <h3 class="mt-3">
                        CV Strength:
                        {{ cvScore >= 80 ? 'Excellent' : cvScore >= 50 ? 'Good' : 'Needs Work' }}
                      </h3>
                    </div>
                    <button type="button" class="btn btn-outline-primary mb-4" (click)="scoreCv()">
                      ✨ Analyze CV with AI
                    </button>
              ...
              <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                ...
                @if (currentStep === totalSteps) {
                  <button type="button" class="btn btn-primary px-4" (click)="finish()">
                    Finish & Save
                  </button>
                }
              </div>
          ...
          <div class="col-sidebar d-none d-lg-block">
            <div class="card p-4 shadow-sm border-none sticky-sidebar">
              ...
              @if (currentStep === 1) {
                <div class="suggestion-item">
                  <p class="small text-muted mb-2">
                    Ensure your target job title aligns precisely with the roles you are applying
                    for to optimize ATS visibility.
                  </p>
                </div>
              }
              @if (currentStep === 2) {
                <div class="suggestion-item">
                  <p class="small text-muted mb-2">
                    A strong summary uses action verbs and quantifies achievements. Click the
                    "Generate with AI" button and we'll draft it based on your target role.
                  </p>
                </div>
              }
              @if (currentStep === 3) {
                <div class="suggestion-item">
                  <p class="small text-muted mb-2">
                    Use the "Build Achievement" tool. Input a basic task, and our AI will rewrite it
              ...
              @if (currentStep === 7) {
                <div class="suggestion-item">
                  <p class="small text-muted mb-2">
                    Our AI calculates your CV score based on impact, brevity, and keyword richness.
                    Score 80+ for the best chance at landing interviews.
                  </p>
                </div>
              }
            </div>
