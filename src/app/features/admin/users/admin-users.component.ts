...
@Component({
        ...
        <table class="table mb-0">
          ...
          <tbody>
            <tr *ngFor="let user of users">
              <td><span class="small text-muted">{{ user.id }}</span></td>
  ...
  styles: [`
    ...
    .badge-danger { background: var(--qt-danger); }
    ...
    .btn-outline-danger { border: 1px solid var(--qt-danger); color: var(--qt-danger); background: transparent; }
    .btn-outline-danger:hover { background: rgba(220,53,69,0.1); }
    .btn-outline-success { border: 1px solid var(--qt-success); color: var(--qt-success); background: transparent; }
    .btn-outline-success:hover { background: rgba(40,167,69,0.1); }
  `]
})
