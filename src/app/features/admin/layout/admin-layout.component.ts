    ...
    <div class="admin-wrapper d-flex">
      ...
      <nav class="sidebar bg-navy text-white min-vh-100 p-3 shadow">
        <div class="sidebar-header mb-4 px-2 d-flex align-items-center">
          <div class="qt-logo fs-4 fw-bold text-orange">QT<span class="text-white">Admin</span></div>
        </div>
        
        <ul class="nav flex-column gap-2">
          <li class="nav-item">
            <a routerLink="/admin/dashboard" routerLinkActive="active" class="nav-link text-white rounded p-2">
              <span class="icon me-2">📊</span> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/admin/users" routerLinkActive="active" class="nav-link text-white rounded p-2">
              <span class="icon me-2">👥</span> Users
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/admin/orders" routerLinkActive="active" class="nav-link text-white rounded p-2">
              <span class="icon me-2">🛍️</span> Orders
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/admin/premium" routerLinkActive="active" class="nav-link text-white rounded p-2">
              <span class="icon me-2">⭐</span> Premium Requests
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/admin/pricing" routerLinkActive="active" class="nav-link text-white rounded p-2">
