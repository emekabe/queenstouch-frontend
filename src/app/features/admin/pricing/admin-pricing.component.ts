...
@Component({
      ...
      <div class="card p-4 shadow-sm border-none bg-white w-100" style="max-width: 800px;">
        <form [formGroup]="pricingForm" (ngSubmit)="savePricing()">
          <table class="table mb-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="number" class="form-control" formControlName="STANDARD_CV_DOWNLOAD">
                </td>
              </tr>
              <!-- Academic CV -->
              <tr>
                ...
                <td>
                  <input type="number" class="form-control" formControlName="ACADEMIC_CV_DOWNLOAD">
                </td>
              </tr>
              <!-- Bundle -->
              <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="number" class="form-control" formControlName="COVER_LETTER_DOWNLOAD">
                </td>
              </tr>
              <!-- Expert Review -->
              <tr>
          ...
          <div class="d-flex justify-content-end">
            <button type="submit" class="btn btn-primary" [disabled]="pricingForm.invalid || isLoading">
              💾 Save Pricing Rules
            </button>
          </div>
        </form>
  ...
  styles: [`
    ...
    .font-monospace { font-family: monospace; background: #f0f0f0; padding: 2px 4px; border-radius: 4px; }
  `]
})
