...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, FormsModule, RouterModule, SpinnerComponent, NavbarComponent],
  template: `
    ...
    <div class="bg-secondary min-vh-100 py-5">
      ...
      <div class="container" style="max-width: 800px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <a routerLink="/cover-letters/list" class="btn btn-outline-secondary btn-sm"
            >Back to List</a
          >
        </div>
          ...
          <form [formGroup]="clForm" (ngSubmit)="generate()">
            ...
            <div class="form-group mt-3">
              ...
              <textarea
                ...
                rows="3"
                placeholder="I have 5 years of agile experience..."
              ></textarea>
            </div>
            ...
            <button
              ...
              [disabled]="clForm.invalid || isLoading"
            >
...
export class CoverLetterBuilderComponent {
  ...
  generate() {
    ...
    const combinedExp =
      [v.jobDescription, v.userExperience].filter((x) => !!x?.trim()).join('\n\n') ||
      'General application';
