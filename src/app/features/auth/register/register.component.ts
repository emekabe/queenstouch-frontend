        ...
        <form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
          <div class="grid-2">
            <div class="form-group">
              ...
              @if (
                ...
                <div class="text-danger mt-1" style="font-size: 13px;">Required.</div>
              }
            </div>
            <div class="form-group">
          ...
          <div class="form-group">
            ...
            @if (registerForm.get('phone')?.touched && registerForm.get('phone')?.invalid) {
              <div class="text-danger mt-1" style="font-size: 13px;">Phone number is required.</div>
            }
          </div>
          ...
          <div class="form-group">
            ...
            @if (
              ...
              <div class="text-danger mt-2" style="font-size: 14px;">Password is required.</div>
            }
            @if (
              registerForm.get('password')?.touched &&
