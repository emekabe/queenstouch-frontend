        ...
        <div class="p-5">
          ...
          <div class="order-summary mb-5 p-3 rounded bg-light">
            <div class="d-flex justify-content-between mb-2">
              ...
              <span class="fw-bold">{{
                documentType === 'CV' ? 'Resume / CV' : 'Cover Letter'
              }}</span>
            </div>
            <div class="d-flex justify-content-between mb-2">
          ...
          <div class="d-grid gap-3">
            <button
              ...
              class="btn btn-primary btn-lg py-3 shadow-sm border-0 d-flex align-items-center justify-content-center gap-2"
            >
        ...
        <div class="px-5 py-3 bg-light border-top text-center">
          <div class="d-flex justify-content-center gap-4 text-muted opacity-50 small">
            <div class="d-flex align-items-center gap-1">
              <i class="bi bi-lock-fill"></i> Secure
            </div>
            <div class="d-flex align-items-center gap-1">
              <i class="bi bi-lightning-fill"></i> Instant
            </div>
            <div class="d-flex align-items-center gap-1">
              <i class="bi bi-patch-check-fill"></i> Official
            </div>
          </div>
        </div>
      </div>
